...
// for all class and function documentation, see: http://root.cern.ch/root/html/ClassIndex.html
// (for example, for TH1 go to http://root.cern.ch/root/html/TH1.html)
// some very useful tutorials are here: http://root.cern.ch/root/html/tutorials/
...
void drawHist(Int_t n = 100)
{
  ...
  h->Fit(f,"0"); // useful options are Q0RNM, see: http://root.cern.ch/root/html/TH1.html#TH1:Fit@1
